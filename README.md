...
- `data/exports/daily_post_ready.md`
...
- Daily post-ready sheet removes technical detail and stays fast-to-edit for posting.
...
- Creator-first review sheet is at `data/exports/daily_post_ready.md`.
