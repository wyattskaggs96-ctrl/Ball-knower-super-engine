...
2. Scores trends with a weighted rubric plus a postability score for creator-first prioritization.
...
Use the prebuilt review artifacts:
- `data/exports/example_output.md`
- `data/exports/daily_post_ready.md` (creator-facing daily script sheet for fast review/edit/post)
- `data/exports/top_5_post_now.md` (rapid-pick list for immediate posting)
- `data/exports/video_blueprint.json`

What to evaluate in these files:
- Top 10 selected topics are re-ranked using postability + score blend.
- `daily_post_ready.md` is optimized for quick human editing and same-day posting.
- Each topic includes hooks, editable overlay/caption/CTA, and practical creator notes.
...
- Creator-first daily script sheet is at `data/exports/daily_post_ready.md`.
- Rapid-pick list is at `data/exports/top_5_post_now.md`.
